...
%subs=[1,150,1];      % start from index '1'
%subc=[-1,1,-1];     % '-1' to plot all points in this dimension
%subt=[1,1,1];

subs=[150,1,1];      % start from index '1'
subc=[1,-1,-1];     % '-1' to plot all points in this dimension
subt=[1,1,1];
...
ou_fnm_prefix = ['medium_surf_x150_' varnm]
%ou_fnm_prefix = ['medium_surf_y150_' varnm]
...
if flag_print
    ...
    print(gcf,[ou_fnm_prefix '.png'],'-dpng');
end
