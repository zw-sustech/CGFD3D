/*******************************************************************************
 * Staggered Grid Finite Difference Seismic Wave Propagation Simulation 
 *
...
//-------------------------------------------------------------------------------
  ...
  blk_stg_el1st_mesg_init(mympi, gdinfo->ni, gdinfo->nj, gdinfo->nk,
