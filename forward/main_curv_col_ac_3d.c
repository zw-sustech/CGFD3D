/*******************************************************************************
 * Curvilinear Grid Finite Difference Seismic Acoustic Wave Propagation Simulation 
 *
...
//-------------------------------------------------------------------------------
  ...
  if (par->is_export_grid==1)
  {
    ...
    if (myid==0) fprintf(stdout,"do not export grid coord\n"); 
  }
  fprintf(stdout, " --> done\n"); fflush(stdout);
...
//-------------------------------------------------------------------------------
  ...
  if (par->is_export_media==1)
  {
    ...
    if (myid==0) fprintf(stdout,"do not export media\n"); 
  }
