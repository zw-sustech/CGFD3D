...
%	[TFR,T,F]=TFRRIDH(X,T,N,G,H,TRACE) Reduced Interference
%	Distribution with a kernel based on the Hanning window.
%	TFRRIDH computes either the distribution of a discrete-time 
%	signal X, or the cross representation between two signals. 
% 
%	X     : signal if auto-RIDH, or [X1,X2] if cross-RIDH.
...
%	        output arguments, TFRRIDH runs TFRQVIEW.
