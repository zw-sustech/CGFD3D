...
%	Distribution with a kernel based on the triangular (or Bartlett)
%	window. 
%	TFRRIDT computes either the distribution of a discrete-time 
%	signal X, or the cross representation between two signals. 
% 
%	X     : signal if auto-RIDT, or [X1,X2] if cross-RIDT.
...
%	        output arguments, TFRRIDT runs TFRQVIEW.
