...
subs=[50,50,1];     % start from index '1'
...
elseif ny == 1
    plot(squeeze(x(1:pltincre1:end,1:pltincre2:end),[2,1]),...
         squeeze(z(1:pltincre1:end,1:pltincre2:end),[2,1]),...
         'k-');
    hold on;
    ...
    plot(squeeze(x(1:pltincre1:end,1:pltincre2:end),[2,1]),...
         squeeze(y(1:pltincre1:end,1:pltincre2:end),[2,1]),...
         'k-');
    hold on;
    plot(x(1:pltincre1:end,1:pltincre2:end),...
