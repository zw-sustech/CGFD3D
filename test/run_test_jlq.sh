...
#-- program related dir
EXEC_DIR=/export/home/jianglq/CGFD3D-elastic
EXEC_WAVE=$EXEC_DIR/cgfdm3d_elastic_mpi

#-- conf
PROJDIR=/export/home/jianglq/work/cgfd_opt/1media
...
cat << ieof > $PAR_FILE
{
  ...
  "media_input" : {
      ...
      "in_3grd_file" : "${IN_MEDIA_3GRD_FILE}"
  },
  "is_export_media" : 1,
